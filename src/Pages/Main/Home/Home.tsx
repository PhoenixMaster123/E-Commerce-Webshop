        ...
        <div className="min-h-screen bg-white dark:bg-gray-900 text-gray-900 dark:text-gray-100">
            ...
            <section className="relative h-64 md:h-96 bg-gradient-to-r from-blue-500 to-indigo-600 flex items-center justify-center">
                <div className="text-center px-4">
                    ...
                    <p className="text-lg md:text-2xl text-white mb-6">Your one-stop shop for the best deals and latest trends.</p>
                    <Link
                        to="/products"
                    ...
                    <section key={cat}>
                        ...
                        <div className="relative">
                            <button
                                ...
                                className="absolute left-0 top-1/2 transform -translate-y-1/2 bg-gray-200 dark:bg-gray-700 p-2 rounded-full shadow z-10"
                            >‹</button>
                            <div
                            ...
                            <button
                                ...
                                className="absolute right-0 top-1/2 transform -translate-y-1/2 bg-gray-200 dark:bg-gray-700 p-2 rounded-full shadow z-10"
                            >›</button>
                        </div>
                    </section>
                ))}
